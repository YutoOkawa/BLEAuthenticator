...
#ifndef BIG_B1024_28_H
#define BIG_B1024_28_H
...
#define BIGBITS_B1024_28 (8*MODBYTES_B1024_28)
#define NLEN_B1024_28 (1+((8*MODBYTES_B1024_28-1)/BASEBITS_B1024_28))
#define DNLEN_B1024_28 2*NLEN_B1024_28
#define BMASK_B1024_28 (((chunk)1<<BASEBITS_B1024_28)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_B1024_28 (1<<(CHUNK-BASEBITS_B1024_28-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_B1024_28 (BASEBITS_B1024_28/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_B1024_28 (((chunk)1<<HBITS_B1024_28)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_B1024_28 NLEN_B1024_28
#define MNV_B1024_28 (NLEN_B1024_28+1)
#define DMPV_B1024_28 DNLEN_B1024_28
#define DMNV_B1024_28 (DNLEN_B1024_28+1)
...
#ifdef DEBUG_NORM
typedef chunk BIG[NLEN_B1024_28 + 2]; /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B1024_28 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG[NLEN_B1024_28];     /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B1024_28];   /**< Define type DBIG as array of chunks */
#endif
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    *r = (chunk)prod & BMASK_B1024_28;
    return (chunk)(prod >> BASEBITS_B1024_28);
}
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    top = x1 * y1;
    mid = x0 * y1 + x1 * y0;
    x0 = mid & HMASK_B1024_28;
    x1 = (mid >> HBITS_B1024_28);
    bot += x0 << HBITS_B1024_28;
    bot += *r;
    bot += c;

    top += x1;
    carry = bot >> BASEBITS_B1024_28;
    bot &= BMASK_B1024_28;
    top += carry;
